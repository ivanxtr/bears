...
export class Convert {
	...
	public static aPIMainnetMagicedenIoToJson(value: APIMainnetMagicedenIo): string {
...
const typeMap: any = {
	...
	Result: o(
		[
			...
			{ json: 'updateAuthority', js: 'updateAuthority', typ: r('UpdateAuthority') },
			{ json: 'onChainCollection', js: 'onChainCollection', typ: r('OnChainCollection') },
			...
			{ json: 'collectionName', js: 'collectionName', typ: r('CollectionName') },
			{ json: 'collectionTitle', js: 'collectionTitle', typ: r('CollectionTitle') },
			...
			{ json: 'listingUpdatedAt', js: 'listingUpdatedAt', typ: r('ListingUpdatedAt') },
	...
	V2: o(
		[
			{ json: 'auctionHouseKey', js: 'auctionHouseKey', typ: r('AuctionHouseKey') },
			{ json: 'sellerReferral', js: 'sellerReferral', typ: r('SellerReferral') },
			{ json: 'expiry', js: 'expiry', typ: 0 }
		],
		false
	),
	TraitType: ['Background', 'Clothes', 'Eyes', 'Eyewear', 'Fur', 'Hat', 'Mouth'],
	CollectionName: ['okay_bears'],
	CollectionTitle: ['Okay Bears'],
	Address: ['3xVDoLaecZwXXtN59o6T3Gfxwjcgf8Hc9RfoqBn995P9', '7zL7HVn85F5yFT6XM3BsJcQF7PBcNE7R2BT5GyfunpKe'],
	ListingType: ['M2'],
	...
	SellerReferral: ['autMW8SgBkVYeBgqYiTuJZnkvDZMVU2MHJh9Jh7CSQ2', 'cr5a8uLq6NqxvYz9HCrrhrprPRr5PVRKPNPPgDk8aZo']
};
